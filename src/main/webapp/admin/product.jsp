...
<div id="brall">
    ...
    <div id="condition" style="text-align: center">
        <form id="myform">
            ...
            <input type="button" value="查询" onclick="seeksome()">
        </form>
    </div>
    <br>
    <div id="table">
...
<script type="text/javascript">
    ...
    function del(pid,ispage) {
        if (confirm("确定删除吗")) {
            ...
            var lprice=$("#lprice").val();
            var hprice=$("#hprice").val();
            str="?id="+pid + "&pname"+pname+"&page="+ispage+"&typeid="+typeid+"&lprice="+lprice+"&hprice="+hprice;
          //向服务器提交请求完成删除
    ...
    function one(pid, ispage) {
        ...
        var lprice=$("#lprice").val();
        var hprice=$("#hprice").val();
        str="?pid=" + pid + "&pname"+pname+"&page="+ispage+"&typeid="+typeid+"&lprice="+lprice+"&hprice="+hprice;
